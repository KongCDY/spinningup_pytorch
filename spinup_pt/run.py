import spinup_pt
from spinup_pt.utils.run_utils import ExperimentGrid
...
if __name__ == '__main__':
    ...
    if cmd in valid_help:
        ...
        help_msg = dedent("""
            ...
            \tpython -m spinup_pt.run CMD [ARGS...]
        ...
        special_info = dedent("""
            ...
            \tpython -m spinup_pt.run ppo --env HalfCheetah-v2 --clip_ratio 0.1

            If you need a quick refresher on valid kwargs, get the docstring
            with

            \tpython -m spinup_pt.run [algo] --help
