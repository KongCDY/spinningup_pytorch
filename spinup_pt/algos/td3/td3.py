...
import spinup_pt.algos.td3.core as core
...
"""
def td3(env_fn, actor_critic=core.Actor_Critic, ac_kwargs=dict(), seed=0, 
    ...
    optimizer_critic = optim.Adam(chain(net.critic1.parameters(), net.critic2.parameters()), lr = q_lr)

    # Count variables
    var_counts = (core.count_vars(net.actor), core.count_vars(net.critic1))
    ...
    for t in range(total_steps):
        ...
        if d or (ep_len == max_ep_len):
            ...
            for j in range(ep_len):
                policy_update = True if j % policy_delay == 0 else False
...
if __name__ == '__main__':
    ...
    td3(lambda : gym.make(args.env), actor_critic=core.Actor_Critic,
